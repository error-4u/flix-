      ...
      <section className="relative md:py-24 py-16 overflow-hidden">
        <div className="container relative">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-indigo-800 dark:bg-slate-900 overflow-hidden text-center">
              <div className="relative overflow-hidden text-transparent -m-3">
                <svg
                  ...
                  className="h-32 w-32 fill-indigo-600/5 mx-auto"
                >
                  <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path>
                </svg>
                <div className="absolute top-2/4 -translate-y-2/4 start-0 end-0 mx-auto text-white rounded-xl transition-all duration-500 ease-in-out text-4xl flex align-middle justify-center items-center">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    strokeWidth="0"
              ...
              <div className="mt-6">
                <a
                  className="text-3xl font-medium transition-all duration-500 ease-in-out hover:text-white"
                  href="/index-course"
                >
                  Faster
                </a>
                <p className="text-white p-5 transition-all duration-500 ease-in-out mt-3">
            ...
            <div className="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl  bg-indigo-800 dark:bg-slate-900 overflow-hidden text-center">
              ...
              <div className="mt-6">
                <a
                  className="text-3xl font-medium transition-all duration-500 ease-in-out hover:text-indigo-600"
                  href="/index-course"
                >
                  Cheaper
                </a>
                <p className="p-5 text-white transition-all duration-500 ease-in-out mt-3">
                  If the distribution of letters and words is random, the reader
                  will not be distracted from making.
                </p>
              </div>
        ...
        <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
              ...
              <div className="col-span-6">
                <div className="grid grid-cols-1 gap-6">
                  <img
                    ...
                    alt=""
                  />
                  <img src="/core2.jpg" className="shadow rounded-md" alt="" />
                </div>
              </div>
              <div className="col-span-6">
                <div className="grid grid-cols-1 gap-6">
                  <img src="/core3.jpg" className="shadow rounded-md" alt="" />
                </div>
              </div>
          ...
          <div className="lg:col-span-7 md:col-span-6">
            <div className="lg:ms-5">
              ...
              <p className="text-slate-700 max-w-xl text-left">
