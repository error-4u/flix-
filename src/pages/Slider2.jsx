...
function Slider2() {
  ...
  return (
    <div className="slider-container mt-100 p-20 ">
      ...
      <Slider {...settings}>
        <div
          class="px-3 p-10 sm:grid-cols-1 grid rounded-md shadow dark:shadow-gray-800 group text-center bg-darktext hover:bg-indigo-600/5 dark:hover:bg-indigo-600/5 transition duration-500 m-2 hover:text-black"
        ...
        >
          ...
          <div class="content text-left mt-6 p-3">
            <a
              class="title h5 text-lg font-medium hover:text-blue-600 text-white"
              href="/index-course"
            >
              Create multiple accounts
            </a>
            <p className="text-left mt-4 text-slate-400">
              Create multiple accounts linked to one EOA, no need to transfer
              gas to multiple wallets
            </p>
          </div>
        </div>
